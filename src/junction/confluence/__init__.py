...
from junction.confluence.json import ApiEncoder, ApiDecoder

class _ApiClient(object):

    default_headers = {"X-Atlassian-Token": "no-check",
    ...
    def get(self, resource_path, query_params=None, headers=None, body=None):
        return self.__call_api(resource_path, "GET", query_params=query_params, headers=headers, body=body)

    def post(self, resource_path, query_params=None, headers=None, body=None):
        return self.__call_api(resource_path, "POST", query_params=query_params, headers=headers, body=body)

    def put(self, resource_path, query_params=None, headers=None, body=None):
        return self.__call_api(resource_path, "PUT", query_params=query_params, headers=headers, body=body)

    def delete(self, resource_path, query_params=None, headers=None, body=None):
        return self.__call_api(resource_path, "DELETE", query_params=query_params, headers=headers, body=body)

    def __call_api(self, resource_path, method, query_params=None, headers=None, body=None):
        ...
        if (method == "GET"):
            ...
            raise NotImplementedError("API client does not support {} method".format(method))
